...
// Per ogni id nell’array, usa la funzione getActress
// che hai creato nella Milestone 3 per recuperare l’attrice corrispondente.

// L'obiettivo è ottenere una lista di risultati in parallelo,
// quindi dovrai usare Promise.all.

// La funzione deve restituire un array contenente elementi di
// tipo Actress oppure null (se l’attrice non è stata trovata). 
